...
app.controller('vendorReportsCtrl', function ($scope, $compile, $ajax, $rootScope) {
    ...
    $scope.editVendor = function () {
        var vendorUid = $(event.currentTarget).closest('td').find('input[name="uid"]').val();
        location.href = '../GoodsReport/AddVendor?vendorId=' + vendorUid;
    }
